...
const DATASETS = [
  ...
  },
  {
    ...
    contentTypes: ["PDF", "Citations", "Formulas", "Figures"],
    articleCount: 25,
    ready: false,
  },
  {
    ...
    license: "MIT",
    description: "Complete Next.js docs including App Router, API reference, tutorials, and migration guides.",
  ...
  },
  {
    ...
    source: "data.nasa.gov + PDS",
    license: "Public Domain",
    description: "Mars mission data spanning decades: rover imagery metadata, atmospheric readings, and mission reports.",
    contentTypes: ["CSV", "JSON", "PDF reports", "Imagery metadata"],
    articleCount: 40,
    ready: false,
  },
];
